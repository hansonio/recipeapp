...
namespace Hanson.RecipeApp.Data.SeedData
{
    ...
    public class SeedDataService
        ...
        protected async Task EnsureUsers(){
            ...
            var seedUsers = new []{
                new {Id = "f2cdb728-b176-46d3-9546-131328a061be", Email = "admin@test.local", Password = "P@ssword2", Roles = new[]{"admin", "orgadmin"} }
